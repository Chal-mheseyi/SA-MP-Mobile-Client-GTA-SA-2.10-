...
//    }
    ...
    val list = hashMapOf(
        ...
        403 to Vehicle("MAZ", 7_000_000, 0),
        404 to Vehicle("Mitsubishi Lancer IX", 1_140_000, 570),
        405 to Vehicle("BMW E60", 1_350_000, 675),
        406 to Vehicle("Gazon", 7_000_000, 0),
        407 to Vehicle("MAN Fire Truck", 7_000_000, 0),
        408 to Vehicle("Mercedes-Benz Garbage Truck", 7_000_000, 0),
        409 to Vehicle("Gaz Chaika", 7_000_000, 0),
        ...
        413 to Vehicle("Ford Armored Truck", 7_000_000, 0),
        414 to Vehicle("Mercedes-Benz Fuel Truck", 7_000_000, 0),
        415 to Vehicle("Lamborghini Huracan", 14_000_000, 7000),
        416 to Vehicle("Ford Transit Ambulance", 7_000_000, 0),
        ...
        450 to Vehicle("Trailer_2", 7_000_000, 0),
        ...
        455 to Vehicle("Snowplow", 7_000_000, 0),
        ...
        462 to Vehicle("Vyatka Moped", 7_000_000, 0),
        ...
        471 to Vehicle("Snowmobile", 5_000_000, 2500),
        ...
        499 to Vehicle("GAZ Bread Van", 7_000_000, 0),
        ...
        508 to Vehicle("UAZ-452", 7_000_000, 0),
        ...
        515 to Vehicle("KAZ", 7_000_000, 0),
        ...
        525 to Vehicle("Mercedes-Benz Tow Truck", 7_000_000, 0),
        ...
        531 to Vehicle("Tractor", 7_000_000, 0),
        532 to Vehicle("Combine Harvester", 7_000_000, 0),
        533 to Vehicle("Mercedes-Benz C63 FSB", 7_000_000, 0),
        ...
        540 to Vehicle("UAZ Patriot", 1_000_000, 500),
        ...
        545 to Vehicle("Moskvich 149", 7000000, 25000),
        ...
        552 to Vehicle("Kamaz FSB", 7000000, 25000),
        553 to Vehicle("Nevada", 7000000, 25000),
        554 to Vehicle("Daewoo Matiz", 350_000, 175),
        555 to Vehicle("ZAZ 968", 7000000, 50000),
        ...
        578 to Vehicle("Snowplow", 7000000, 25000),
        ...
        596 to Vehicle("Skoda Octavia Police", 7_000_000, 0),
        597 to Vehicle("LADA Priora Police", 7_000_000, 0),
        598 to Vehicle("Mercedes-Benz C63 Police", 7_000_000, 0),
        ...
        605 to Vehicle("Rocket", 7_000_000, 0)
    )
}
